...
__all__ = [
    'SRSInactiveWithPurge', 'SVP_19', 'SGDSActiveWithAutoPause',
    'SPEI_TTS_PRIVATE', 'Speech_StreamPos_Asap',
    'DISPID_SpeechWaveFormatEx', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpRecognizer3', 'DISPID_SRSetPropertyNumber', 'DISPID_SPRsItem',
    'SVP_16', 'ISpStreamFormatConverter', 'DISPID_SLWType',
    'DISPID_SDKSetLongValue', 'SPSLMA', 'ISpShortcut',
    'DISPID_SPRDisplayAttributes', 'SpeechBookmarkOptions',
    'DISPID_SRCRequestedUIType', 'SPFM_NUM_MODES',
    'SpeechUserTraining', 'SVSFIsXML', 'SAFT44kHz8BitMono',
    'eWORDTYPE_DELETED', 'SpFileStream', 'SREPrivate', 'SVEAllEvents',
    'SDTPronunciation', 'SpeechEngineProperties', 'SPSInterjection',
    'DISPID_SRCEAdaptation', 'SpeechPropertyResponseSpeed',
    'DISPID_SPEsCount', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SGDSActiveUserDelimited', 'ISpObjectToken', 'DISPID_SLPLangId',
    'SECFIgnoreWidth', 'SP_VISEME_1', 'SRSEDone',
    'DISPID_SOTCategory', 'SpeechAudioFormatGUIDText',
    'DISPID_SRGDictationLoad',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpeechFormatType',
    'SVEStartInputStream', 'DISPID_SREmulateRecognition',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRRAudioFormat',
    'DISPID_SRRSaveToMemory', 'SPINTERFERENCE_TOOQUIET', 'SPEVENT',
    'SAFT22kHz8BitStereo', 'SpeechVoiceSkipTypeSentence', 'IStream',
    'DISPID_SPEEngineConfidence', 'SP_VISEME_14', 'DISPID_SOTsItem',
    'DISPID_SVEventInterests', 'SFTSREngine',
    'SpStreamFormatConverter', 'SP_VISEME_15', 'eLEXTYPE_PRIVATE10',
    'SAFT11kHz8BitStereo', 'SpeechCategoryAudioIn',
    'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_PRIVATE12',
    'SPEI_HYPOTHESIS', 'DISPID_SRCEPropertyNumberChange', 'SVP_11',
    'SAFTGSM610_44kHzMono', 'SRTStandard', 'SPXRO_SML',
    'ISpeechPhraseAlternates', 'SpeechAudioFormatType',
    'DISPID_SBSSeek', 'SPAUDIOBUFFERINFO',
    'DISPID_SRAudioInputStream', 'DISPID_SGRAddResource',
    'SPSHORTCUTTYPE', 'eLEXTYPE_PRIVATE8', 'DISPID_SVSpeak',
    'SRTExtendableParse', 'ISpPhoneConverter', 'DISPID_SGRSTText',
    'DISPID_SVEEnginePrivate', 'DISPID_SVEPhoneme',
    'ISpeechPhraseElement', 'ISpeechRecoContext',
    'DISPID_SpeechRecognizerStatus', 'SPEI_UNDEFINED',
    'DISPID_SRCVoicePurgeEvent', 'SVP_21', 'SGLexical',
    'SPXRO_Alternates_SML', 'SGRSTTEpsilon',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRCCreateGrammar',
    'SPINTERFERENCE_NOISE', 'DISPID_SRGCmdLoadFromResource', 'SVP_9',
    'DISPID_SRStatus', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPIRule', 'Speech_Max_Word_Length',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVSInputWordLength',
    'SVP_17', 'SpeechVisemeType', 'SAFT44kHz16BitMono', 'SLTUser',
    'DISPID_SRIsUISupported', 'ISpAudio',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPAR_Low', 'SRCS_Enabled',
    'ISpeechPhraseRule', 'DISPID_SVAudioOutput', 'DISPID_SLPPhoneIds',
    'ISpeechCustomStream', 'SPEI_RESERVED5',
    'SpeechCategoryPhoneConverters', 'SDKLDefaultLocation',
    'SVEWordBoundary', 'SPSModifier', 'ISpNotifyTranslator',
    'SECFEmulateResult', 'SPPS_Noun', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpStreamFormat',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechLexiconWord',
    'DISPID_SPRuleFirstElement', 'DISPID_SVEStreamStart',
    'ISpMMSysAudio', 'SPSEMANTICFORMAT', 'SpeechTokenShellFolder',
    'SITooQuiet', 'SVEAudioLevel', 'SPCT_SUB_DICTATION', 'SpLexicon',
    'SPLOADOPTIONS', 'SAFTCCITT_uLaw_22kHzStereo',
    'SDKLCurrentConfig', 'SpeechPropertyResourceUsage',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechVoice', 'SPRULE', 'DISPID_SGRsCommitAndSave',
    'SPAO_RETAIN_AUDIO', 'SVP_7', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpeechTokenIdUserLexicon', 'DISPID_SPEAudioTimeOffset',
    'SVSFUnusedFlags', 'SAFT16kHz8BitMono', 'SPRST_ACTIVE',
    'SPPHRASEELEMENT', 'SREAdaptation', 'SECFDefault', 'SPRULESTATE',
    'eLEXTYPE_PRIVATE3', 'SSSPTRelativeToEnd', 'SPVOICESTATUS',
    'SVEVoiceChange', 'SPEI_INTERFERENCE', 'SPSHT_NotOverriden',
    'SDKLLocalMachine', 'STSF_CommonAppData',
    'DISPID_SPIReplacements', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechVoiceStatus', 'SpeechAllElements',
    'SECLowConfidence', 'DISPID_SOTCId', 'SpeechTokenContext',
    'SSFMOpenReadWrite', 'SPAUDIOSTATUS', 'SVF_Stressed',
    'SpeechEngineConfidence', 'ISpeechXMLRecoResult',
    'SpeechDisplayAttributes', 'DISPID_SRCEStartStream',
    'SRERequestUI', 'SREStreamEnd', 'DISPID_SPPConfidence',
    'SVSFNLPMask', 'DISPID_SOTsCount', 'DISPID_SAFGuid',
    'ISpeechLexiconPronunciations', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVSFlagsAsync', 'SGSEnabled', 'SREPropertyStringChange',
    'SECFIgnoreCase', 'DISPID_SVPriority', 'ISpDataKey', 'SAFTText',
    'SPPS_RESERVED4', 'SPSVerb', 'SLTApp', 'DISPID_SRDisplayUI',
    'SpeechAudioFormatGUIDWave', 'SpeechGrammarState',
    'DISPID_SPCPhoneToId', 'DISPID_SBSRead',
    'DISPID_SPIGetDisplayAttributes',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SLGetPronunciations', 'SPEI_SR_PRIVATE', 'eLEXTYPE_APP',
    'SRESoundStart', 'SPCATEGORYTYPE', 'STCRemoteServer',
    'SPGRAMMARSTATE', 'SAFT16kHz8BitStereo', 'DISPID_SPRsCount',
    'DISPID_SGRSTType', 'DISPID_SRRRecoContext',
    'DISPID_SPERetainedStreamOffset', 'SPRS_INACTIVE',
    'eLEXTYPE_PRIVATE7', 'DISPID_SOTCDefault', 'SASStop',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPEDisplayText',
    'SPDKL_DefaultLocation', 'DISPID_SOTSetId', 'SPEI_RECOGNITION',
    'eWORDTYPE_ADDED', 'DISPID_SpeechPhraseElements',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRIsShared', 'SSTTTextBuffer', 'SGSExclusive',
    'SAFTCCITT_ALaw_44kHzMono', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechPhraseRules', 'DISPID_SPCIdToPhone',
    'DISPID_SPAPhraseInfo', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SVVoice', 'SAFT8kHz16BitStereo',
    'DISPID_SRRTOffsetFromStart', 'SVSFPersistXML',
    'DISPID_SpeechPhraseProperties', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechVoiceStatus',
    'IEnumString', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SPCLangId',
    'SVP_1', 'SBONone', 'SPAS_CLOSED', 'DISPID_SRGId',
    'SAFTGSM610_22kHzMono', 'SPBO_AHEAD', '_SPAUDIOSTATE',
    'SPCS_DISABLED', 'SPSHT_OTHER', 'SpeechCategoryAppLexicons',
    'SREStreamStart', 'DISPID_SABufferNotifySize',
    'SRERecoOtherContext', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_PRIVATE4', 'SSFMOpenForRead', 'DISPID_SVEViseme',
    'DISPID_SGRSAddWordTransition', 'DISPIDSPRG',
    'DISPID_SVGetVoices', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SpeechCustomStream', 'ISpRecognizer',
    'DISPID_SPRNumberOfElements', 'SP_VISEME_10', 'SRADynamic',
    'SpeechTokenValueCLSID', 'Speech_Max_Pron_Length',
    'SAFTADPCM_44kHzMono', 'SpPhraseInfoBuilder',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_PRIVATE1',
    'SVSFIsNotXML', 'SAFT48kHz8BitStereo', 'SPAR_High',
    'SpMemoryStream', 'SVPNormal', 'DISPID_SPEDisplayAttributes',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_8', 'DISPID_SLWsItem',
    'SAFTNonStandardFormat', 'DISPID_SGRsAdd',
    'DISPID_SpeechVoiceEvent', 'ISpNotifySink', 'SRADefaultToActive',
    'SVSFParseMask', 'SPSSuppressWord',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRSAddRuleTransition', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRSpeakAudio', 'SpeechPropertyAdaptationOn',
    'Speech_Default_Weight', 'DISPID_SWFEFormatTag', 'DISPID_SFSOpen',
    'DISPID_SAEventHandle', 'ISpeechLexiconPronunciation',
    'SpObjectToken', 'SpInprocRecognizer', 'DISPID_SGRSTPropertyName',
    'DISPID_SPAs_NewEnum', 'SPWT_DISPLAY', 'SpResourceManager',
    'ISpEventSource', 'SVSFParseSsml', 'DISPID_SpeechXMLRecoResult',
    'SPAS_PAUSE', 'SpPhoneticAlphabetConverter', 'SPBO_PAUSE',
    'DISPID_SGRSTRule', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SRGCmdLoadFromFile', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechRecognizer', 'SPEI_PROPERTY_STRING_CHANGE', 'SPRS_ACTIVE',
    'SAFTADPCM_11kHzStereo', 'DISPID_SOTMatchesAttributes',
    'SVSFDefault', 'DISPID_SPAsItem', 'UINT_PTR', 'SASRun',
    'DISPID_SADefaultFormat', 'DISPID_SpeechMemoryStream',
    'SPAUDIOSTATE', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SWFEBitsPerSample', 'ISpeechDataKey', 'SPPS_Interjection',
    'SDTDisplayText', 'SPSTREAMFORMATTYPE', 'ISpeechRecoResultTimes',
    'SDTAudio', 'SPEI_END_INPUT_STREAM', 'SPCT_COMMAND',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRCERecognition',
    'DISPID_SGRSTs_NewEnum', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRGCommit', 'SRTReSent', 'DISPID_SMSADeviceId',
    'DISPID_SLWsCount', 'DISPID_SLAddPronunciation',
    'SpSharedRecoContext', 'SpeechRegistryLocalMachineRoot',
    'SpeechRuleState', 'SPSERIALIZEDPHRASE', 'DISPID_SPPs_NewEnum',
    'SAFT32kHz16BitMono', 'SREPropertyNumChange',
    'ISpeechGrammarRule', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SGRSTPropertyValue', 'ISpeechWaveFormatEx',
    'SPDKL_CurrentUser', 'SSTTWildcard', 'SPEI_MIN_SR', 'SPVISEMES',
    'SP_VISEME_12', 'SpeechRegistryUserRoot',
    'DISPID_SRCEventInterests', 'SPPS_NotOverriden',
    'eLEXTYPE_PRIVATE2', 'DISPID_SPIElements', 'SVP_2',
    'DISPID_SPPNumberOfElements', 'DISPID_SVSpeakStream',
    'SpCompressedLexicon', 'DISPID_SPIEngineId', 'SVSFIsFilename',
    ...
    'SPRST_NUM_STATES', 'tagSPPROPERTYINFO', 'SAFTADPCM_8kHzMono',
    'WAVEFORMATEX', 'SAFT8kHz16BitMono', 'ISpGrammarBuilder',
    'DISPID_SVSCurrentStreamNumber', 'SVP_5',
    'IInternetSecurityMgrSite', 'SpeechDataKeyLocation',
    'DISPID_SGRSTPropertyId', 'SPAS_RUN', 'ISpPhraseAlt',
    'SpeechTokenKeyUI', 'SpeechRecognitionType', 'SVP_0',
    'SVEPrivate', 'SAFT44kHz8BitStereo', 'DISPID_SGRsItem',
    'SpeechPropertyComplexResponseSpeed', 'SVP_15', 'SRTEmulated',
    'SPWT_LEXICAL', 'SPEI_FALSE_RECOGNITION', 'DISPID_SRCESoundStart',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechPhraseRule',
    'SVPAlert', 'DISPID_SpeechObjectToken', 'SPPHRASERULE',
    'SRATopLevel', 'SSFMCreate', 'DISPID_SRCERequestUI',
    'SpSharedRecognizer', 'SDA_Consume_Leading_Spaces',
    'SPVPRI_ALERT', 'SPVPRIORITY', 'DISPID_SPRuleName',
    'SPPS_SuppressWord', 'STCInprocServer',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SGRSRule',
    'SPEI_SR_RETAINEDAUDIO', 'ISpProperties',
    'DISPID_SpeechBaseStream', 'SPPS_Function', 'SPSHT_Unknown',
    'SPPS_RESERVED2', 'SPSHT_EMAIL', 'ISpVoice',
    'SpeechGrammarWordType', 'DISPID_SpeechAudioFormat',
    'DISPID_SRGIsPronounceable', 'DISPID_SLWPronunciations',
    'SPWF_INPUT', 'DISPID_SDKEnumValues', 'DISPID_SVEVoiceChange',
    'SPDKL_CurrentConfig', 'ISpeechAudioStatus', 'SVF_Emphasis',
    'LONG_PTR', 'ISpLexicon', 'DISPID_SOTDataKey', 'DISPID_SAFType',
    'DISPID_SRCState', 'eLEXTYPE_PRIVATE20', 'DISPID_SGRSTsItem',
    'SPSHORTCUTPAIRLIST', 'ISpeechPhraseElements',
    'DISPID_SpeechPhraseElement', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPRuleChildren', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRRAlternates', 'SGDisplay', 'DISPID_SPIAudioSizeBytes',
    'SDA_No_Trailing_Space', 'DISPID_SLPsItem', 'DISPID_SVEStreamEnd',
    'DISPID_SGRsFindRule', 'SPSMF_UPS', 'ISpeechAudioBufferInfo',
    'SAFT8kHz8BitMono', 'SREAudioLevel', 'SAFTCCITT_ALaw_11kHzMono',
    'SGRSTTRule', 'SAFT12kHz16BitStereo', 'SAFT48kHz8BitMono',
    'ISpeechPhoneConverter', 'DISPID_SRGDictationSetState',
    'DISPID_SVAudioOutputStream', 'SINone', 'SAFT24kHz16BitMono',
    'DISPID_SPPParent', 'SPEI_RESERVED1', 'SREInterference',
    'DISPID_SRCEFalseRecognition', 'ISpeechObjectTokenCategory',
    'ISpeechMemoryStream', 'DISPID_SFSClose', 'SP_VISEME_4',
    'SpInProcRecoContext', 'STCAll', 'SGDSInactive',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCBookmark', 'ISpeechAudio', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechMMSysAudio', 'ISpResourceManager',
    'DISPID_SASetState', 'SRCS_Disabled', 'SPEI_WORD_BOUNDARY',
    'DISPID_SLGetGenerationChange', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SDKOpenKey', 'SAFT12kHz16BitMono', 'SRAInterpreter',
    'DISPID_SLPs_NewEnum', 'DISPID_SGRAddState',
    'SPEI_RECO_STATE_CHANGE', 'SGRSTTWildcard', 'SP_VISEME_6',
    'SAFT16kHz16BitMono', 'SAFTADPCM_8kHzStereo', 'SPEI_RESERVED2',
    'SPGS_EXCLUSIVE', 'STSF_AppData', 'DISPID_SRRSetTextFeedback',
    'DISPID_SVWaitUntilDone', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SLWWord', 'SPEI_REQUEST_UI',
    'SPFM_OPEN_READWRITE', 'SPFM_CREATE_ALWAYS',
    'ISpeechRecoResultDispatch', 'SAFTADPCM_44kHzStereo',
    'DISPID_SDKGetlongValue', 'DISPID_SPIGrammarId',
    'DISPID_SMSAMMHandle', 'ISpXMLRecoResult',
    'DISPID_SPEActualConfidence', 'SPEI_SOUND_END', 'DISPID_SVSkip',
    'DISPID_SPIAudioSizeTime',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEVENTSOURCEINFO',
    'SRSEIsSpeaking', 'SPWORDPRONUNCIATIONLIST', 'SPDATAKEYLOCATION',
    'SGDSActive', 'DISPID_SPAStartElementInResult', 'SpAudioFormat',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechObjectTokens',
    'DISPID_SPACommit', 'SPPHRASE', 'SPWORDPRONOUNCEABLE',
    'SREAllEvents', 'SpeechCategoryVoices', 'DISPID_SVSRunningState',
    'SpShortcut', 'DISPID_SDKSetStringValue', 'DISPID_SRGRecoContext',
    'SVEPhoneme', 'SAFTGSM610_11kHzMono', 'DISPID_SRCPause',
    'SAFT8kHz8BitStereo', 'ISpeechTextSelectionInformation',
    'SPPS_Noncontent', 'SPAS_STOP', 'SAFT22kHz8BitMono',
    'SPDKL_LocalMachine', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVP_4', 'DISPID_SGRInitialState', 'SRSInactive',
    'DISPID_SpeechLexiconProns', 'DISPID_SVRate',
    'DISPID_SGRSAddSpecialTransition', 'SPGRAMMARWORDTYPE',
    'SWTDeleted', 'eLEXTYPE_PRIVATE5', 'DISPID_SPEAudioSizeTime',
    'SpeechRecognizerState', 'ISpRecoGrammar2',
    'SPINTERFERENCE_TOOSLOW', 'SPVPRI_NORMAL', 'ISpeechBaseStream',
    'DISPID_SPPsItem', 'ISpRecoContext2',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SMSALineId',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPRECORESULTTIMES',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVIsUISupported',
    'SP_VISEME_21', 'SpNotifyTranslator',
    'DISPID_SPERequiredConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SGRAttributes', 'SREBookmark', 'SPWORDLIST',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechAudioStatus', 'ISpRecoResult',
    'SpeechStreamFileMode', 'DISPID_SGRSTsCount',
    'DISPID_SOTCGetDataKey', 'DISPID_SLGenerationId',
    'DISPID_SWFEExtraData', 'SPPS_RESERVED1', 'SAFT32kHz8BitMono',
    'SPLO_STATIC', 'SVP_20', 'SDTRule', 'DISPID_SDKGetStringValue',
    'DISPID_SRCEInterference',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SRCESoundEnd',
    'SPPS_Unknown', 'SVEBookmark', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SDKDeleteValue', 'DISPID_SPPValue', 'SpMMAudioOut',
    'ISpeechRecognizerStatus', 'DISPID_SpeechLexiconWord',
    'ISpeechGrammarRules', 'SPRST_INACTIVE', 'DISPID_SRRTStreamTime',
    'ISpeechPhraseReplacements', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLPPartOfSpeech', 'DISPID_SVSLastResult',
    'SAFTCCITT_uLaw_8kHzStereo', 'SRTAutopause', 'DISPID_SRRTLength',
    'DISPID_SAStatus', 'SPFM_CREATE', 'ISpeechRecoGrammar',
    'SASClosed', 'SpeechGrammarTagWildcard',
    'SpeechStreamSeekPositionType', 'SPEVENTENUM',
    'DISPID_SRCSetAdaptationData', 'SAFT48kHz16BitStereo',
    'SPRECOGNIZERSTATUS', 'DISPID_SBSWrite',
    'SpTextSelectionInformation', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPRuleId', 'SREHypothesis', 'SPPHRASEREPLACEMENT',
    'SAFTNoAssignedFormat', 'DISPID_SPEAudioSizeBytes',
    'eLEXTYPE_PRIVATE9', 'ISpeechPhraseAlternate', 'DISPID_SASState',
    'ISpStream', 'SAFT32kHz8BitStereo', 'SAFT24kHz8BitStereo',
    'ISpeechObjectToken', 'DISPID_SVDisplayUI', 'DISPID_SPRs_NewEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'SDTLexicalForm',
    ...
    'DISPID_SRGReset', 'SINoise', 'SVP_12', 'SVP_14',
    'DISPID_SVResume', 'DISPID_SpeechRecoResult2', 'SITooSlow',
    'SVSFNLPSpeakPunc', 'SP_VISEME_2', 'SRESoundEnd',
    'SPEI_PHRASE_START', 'SPCS_ENABLED', 'SPEI_END_SR_STREAM',
    'SVP_13', 'DISPID_SRAudioInput', 'DISPID_SRCVoice',
    'DISPID_SRRTimes', 'ISpPhoneticAlphabetConverter',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_20',
    'SpeechPropertyHighConfidenceThreshold', 'SpPhoneConverter',
    'DISPID_SpeechRecognizer', 'SDTReplacement',
    'DISPID_SRGetRecognizers', 'SPWF_SRENGINE',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechGrammarRuleState',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_PRIVATE14',
    'DISPID_SDKGetBinaryValue', 'SAFT48kHz16BitMono',
    'DISPID_SRRecognizer', '_RemotableHandle', 'SPPS_LMA',
    'SREFalseRecognition', 'SpeechCategoryRecognizers',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SWFEChannels',
    'SP_VISEME_13', 'DISPID_SVSPhonemeId', 'SVPOver',
    'SECFIgnoreKanaType', 'SPPARTOFSPEECH', 'SECHighConfidence',
    'tagSTATSTG', '__MIDL_IWinTypes_0009', 'SVEViseme',
    'SpeechAddRemoveWord', 'SPWAVEFORMATTYPE', 'DISPID_SPRulesItem',
    'SPEI_ADAPTATION', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPIDSPTSI_SelectionOffset', 'SRERecognition', 'SPBO_NONE',
    'DISPID_SGRName', 'SWTAdded', 'SP_VISEME_16',
    'DISPID_SRRGetXMLResult', 'SVSFPurgeBeforeSpeak', 'SITooFast',
    'DISPID_SDKSetBinaryValue', 'SpeechTokenKeyAttributes',
    'SPPHRASEPROPERTY', 'SVSFParseSapi', 'SDKLCurrentUser',
    'DISPID_SOTs_NewEnum', '_ISpeechRecoContextEvents',
    'SPCT_DICTATION', 'DISPID_SPPName', 'eLEXTYPE_RESERVED10',
    'ISpeechObjectTokens', 'SpeechDiscardType',
    'SAFTExtendedAudioFormat', 'eLEXTYPE_RESERVED7',
    'SAFTCCITT_ALaw_22kHzMono', 'SPEI_RESERVED6', 'SPVPRI_OVER',
    'SP_VISEME_11', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPILanguageId', 'SPEI_MAX_TTS', 'SAFT11kHz8BitMono',
    'SpUnCompressedLexicon', 'ISpNotifySource',
    'DISPID_SVSLastBookmark', 'SAFT11kHz16BitStereo',
    'DISPID_SLPType', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SABufferInfo', 'DISPID_SAFGetWaveFormatEx',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechAudio',
    'DISPID_SLWs_NewEnum', 'SPXMLRESULTOPTIONS',
    'DISPID_SVSLastBookmarkId', 'ISpObjectWithToken',
    'IEnumSpObjectTokens', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechDataKey', 'SpeechInterference', 'SREPhraseStart',
    'eLEXTYPE_RESERVED6', 'SAFT24kHz8BitMono', 'DISPID_SDKCreateKey',
    'SRAImport', 'SRSActiveAlways', 'DISPID_SVGetProfiles',
    'DISPID_SPIRetainedSizeBytes', 'SpeechCategoryAudioOut',
    'DISPID_SPRules_NewEnum', 'ISequentialStream',
    'SPWORDPRONUNCIATION', 'ISpeechPhraseInfo', 'DISPID_SMSSetData',
    'SAFT12kHz8BitMono', 'DISPID_SpeechLexiconPronunciation',
    'SGPronounciation', 'DISPID_SLPsCount', 'DISPID_SPEs_NewEnum',
    'eLEXTYPE_RESERVED8', 'ISpeechResourceLoader', 'SVP_3',
    'ISpeechLexicon', 'DISPID_SRGRules', 'DISPID_SVGetAudioInputs',
    'DISPID_SDKEnumKeys', 'ISpEventSink', 'SITooLoud',
    'DISPID_SVEAudioLevel', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechPhraseProperty', 'SPFILEMODE', 'DISPID_SVEBookmark',
    'SpeechRunState', 'SINoSignal', 'SPEI_TTS_BOOKMARK',
    'SPCONTEXTSTATE', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPBINARYGRAMMAR', 'STSF_FlagCreate',
    'DISPID_SPEAudioStreamOffset', 'ISpeechPhraseReplacement',
    'SPEI_VISEME', 'SPSNoun', 'SVP_18', 'SP_VISEME_18',
    'DISPID_SGRClear', 'SpeechRetainedAudioOptions', 'eLEXTYPE_USER',
    'SPADAPTATIONRELEVANCE', 'ISpObjectTokenCategory', 'SPCT_SLEEP',
    'eLEXTYPE_PRIVATE17', 'ISpeechRecoResult', 'DISPID_SPARecoResult',
    'SBOPause', 'DISPID_SOTDisplayUI', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SGRSTransitions', 'SPTEXTSELECTIONINFO',
    'DISPID_SPPEngineConfidence', 'eLEXTYPE_RESERVED4',
    'SpeechCategoryRecoProfiles', 'DISPID_SpeechObjectTokenCategory',
    'SPLO_DYNAMIC', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRSetPropertyString', 'DISPID_SVESentenceBoundary',
    'SPEI_RESERVED3', 'SpeechRecoProfileProperties',
    'SVSFParseAutodetect', 'ISpeechPhraseRules', 'SGRSTTDictation',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechRecoResult2', 'SpVoice', 'SAFT22kHz16BitMono',
    'SPWORDTYPE', 'SDA_Two_Trailing_Spaces',
    ...
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRGDictationUnload',
    'SpeechVoicePriority', 'SPINTERFERENCE_NONE', 'SDTAll', 'SPWORD',
    'IInternetSecurityManager', 'SpeechWordType', 'SP_VISEME_3',
    'DISPID_SpeechGrammarRules', 'SPSHORTCUTPAIR',
    'SpeechGrammarTagDictation', 'DISPID_SBSFormat',
    'SECFNoSpecialChars', 'SPSFunction', 'ISpRecognizer2',
    'DISPID_SRGetPropertyString', 'DISPID_SpeechPhraseProperty',
    'SFTInput', 'SpeechVisemeFeature', 'DISPID_SRGSetTextSelection',
    'SPAUDIOOPTIONS', 'DISPID_SVSVisemeId', 'SPPROPERTYINFO',
    'SVESentenceBoundary', 'eLEXTYPE_PRIVATE15', 'SPSUnknown',
    'DISPID_SPPFirstElement', 'DISPID_SLPSymbolic',
    'DISPID_SPRulesCount', 'SpNullPhoneConverter', 'SVP_6',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPIProperties',
    'eLEXTYPE_PRIVATE19', 'DISPID_SGRSTWeight', 'SpeechLoadOption',
    'DISPID_SASCurrentDevicePosition', 'SASPause',
    'SAFTCCITT_uLaw_8kHzMono', 'SPSEMANTICERRORINFO',
    'DISPID_SRCEAudioLevel', 'SPEI_TTS_AUDIO_LEVEL',
    'SGLexicalNoSpecialChars', 'DISPID_SABIEventBias',
    'DISPID_SRGCmdLoadFromObject', 'SpObjectTokenCategory',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SVStatus',
    'SPSNotOverriden', 'DISPID_SRGetFormat',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SGRsCount',
    'DISPID_SLGetWords', 'ISpSerializeState', 'SpeechRuleAttributes',
    'SDA_One_Trailing_Space', 'SRTSMLTimeout',
    'DISPID_SLRemovePronunciation', 'DISPID_SRState',
    'DISPID_SLWLangId', 'DISPID_SOTIsUISupported',
    'DISPID_SRSClsidEngine', 'SLODynamic', 'SpeechRecoContextState',
    'eLEXTYPE_PRIVATE16', 'ISpeechPhraseProperties',
    'SpeechRecoEvents', 'DISPIDSPTSI', 'SP_VISEME_7',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SPAsCount',
    'DISPID_SPPId', 'DISPID_SPPsCount', 'SPGS_DISABLED',
    'SPEI_MIN_TTS', 'SPBO_TIME_UNITS', 'SpMMAudioEnum',
    'SPSERIALIZEDRESULT', 'DISPID_SASNonBlockingIO',
    'DISPID_SOTCSetId', 'SpeechPartOfSpeech', 'DISPID_SABIBufferSize',
    'STSF_LocalAppData', 'SPEI_VOICE_CHANGE', 'SpMMAudioIn',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFTADPCM_11kHzMono',
    'ISpRecoContext', 'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SOTId',
    'SVSFVoiceMask', 'DISPID_SRCEEndStream', 'SSFMCreateForWrite',
    'ISpeechLexiconWords', 'DISPID_SOTCreateInstance',
    'DISPID_SASCurrentSeekPosition', 'SpeechEmulationCompareFlags',
    'DISPID_SRGState', 'ISpPhoneticAlphabetSelection',
    'SDTAlternates', 'ISpeechMMSysAudio', 'DISPID_SPELexicalForm',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SGRId', 'SPPS_RESERVED3',
    'SAFT11kHz16BitMono', 'DISPID_SRCRetainedAudioFormat',
    'SPEI_SR_BOOKMARK', 'SpeechLexiconType', 'SRAORetainAudio',
    'STCInprocHandler', 'SPAR_Unknown', 'DISPID_SRCResume',
    'SpeechWordPronounceable', 'ISpRecoCategory', 'SPINTERFERENCE',
    'DISPID_SRGSetWordSequenceData', 'SRARoot',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCRetainedAudio', 'DISPID_SpeechGrammarRule',
    'SGRSTTWord', 'SP_VISEME_19', 'SP_VISEME_0',
    'ISpeechPhraseInfoBuilder', 'SpeechSpecialTransitionType',
    'SpeechMicTraining', 'SPRECOCONTEXTSTATUS',
    'SpeechDictationTopicSpelling', 'SRSActive', 'SP_VISEME_5',
    'SPPS_Modifier', 'DISPID_SRSAudioStatus', 'eLEXTYPE_RESERVED9',
    'SAFT32kHz16BitStereo', 'DISPID_SVGetAudioOutputs',
    'SpCustomStream', 'SGSDisabled', 'SRAExport',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRCCreateResultFromMemory',
    'SPAO_NONE', 'DISPID_SOTRemove', 'SPWT_PRONUNCIATION',
    'SPEI_MAX_SR', 'SPLEXICONTYPE', 'SPAR_Medium',
    'DISPID_SGRsCommit', 'DISPID_SVVolume', 'SPINTERFERENCE_NOSIGNAL',
    'SWPKnownWordPronounceable', 'SAFT12kHz8BitStereo', 'SVP_10',
    'SPCT_SUB_COMMAND', 'ISpPhrase', 'STCLocalServer',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRGCmdSetRuleState',
    'SpWaveFormatEx', 'Speech_StreamPos_RealTime',
    'DISPID_SPRuleConfidence', 'DISPID_SRCEEnginePrivate',
    'DISPID_SGRsDynamic', 'DISPID_SMSGetData', 'SDTProperty',
    'SSTTDictation', 'SPPS_Verb', 'SGRSTTTextBuffer',
    'DISPID_SpeechPhoneConverter', 'DISPID_SAVolume',
    'SAFT16kHz16BitStereo', 'DISPID_SRSSupportedLanguages',
    'SPRECOSTATE', 'ISpRecoGrammar', 'SPGS_ENABLED',
    'DISPID_SASFreeBufferSpace', 'SpeechAudioVolume',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCEHypothesis',
    'DISPID_SOTGetAttribute', 'SpStream', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechFileStream',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRRPhraseInfo',
    'DISPID_SDKDeleteKey', 'eLEXTYPE_PRIVATE11',
    'SPINTERFERENCE_TOOFAST', 'SPEI_START_SR_STREAM',
    'DISPID_SGRs_NewEnum', 'DISPID_SPIGetText',
    'SSSPTRelativeToStart', 'SP_VISEME_8', 'SAFTADPCM_22kHzMono',
    'DISPID_SABIMinNotification', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTGetStorageFileName', 'DISPID_SRCRecognizer',
    'DISPID_SRRAudio', 'DISPID_SVEWord', 'DISPID_SCSBaseStream',
    'DISPID_SVAlertBoundary', 'DISPID_SRProfile',
    'SAFT22kHz16BitStereo', 'DISPID_SPIEnginePrivateData',
    'SpeechVoiceSpeakFlags', 'SpeechAudioState', 'ISpeechVoice',
    'SAFTDefault', 'SVF_None', 'DISPID_SRGetPropertyNumber',
    'SRAONone', 'SPEI_PHONEME', 'SECNormalConfidence',
    'DISPID_SPISaveToMemory', 'DISPID_SRCEBookmark',
    'DISPID_SPIStartTime', 'DISPID_SPRuleParent', 'SPEI_SOUND_START',
    'SREStateChange', 'DISPID_SpeechLexicon', 'DISPID_SPPChildren',
    'SAFT24kHz16BitStereo', 'SP_VISEME_9',
    'DISPID_SRCreateRecoContext', 'DISPID_SPRFirstElement',
    'SPBOOKMARKOPTIONS', 'SLOStatic', 'DISPID_SWFEBlockAlign',
    'SSSPTRelativeToCurrentPosition', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRRTTickCount', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechVoiceEvents',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT44kHz16BitStereo',
    'ISpeechFileStream', 'SP_VISEME_17', 'DISPID_SPEsItem'
]

_check_version('1.1.14', 1617976100.868509)
